...
public class Login implements ActionListener{
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getActionCommand().equals("no_user")) {
            ...
            }else if(Actividades.arbol_b.realizar_login(usuario, contrasena)){
                ArbolB.Nodo nodo = Actividades.arbol_b.realizar_visualizacion(usuario);
                new ModuloCliente(frame, nodo.dpi, usuario);
            }else{
