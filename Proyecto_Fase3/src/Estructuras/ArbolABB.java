...
public class ArbolABB {
    ...
    public void generar_graphviz(String user) {
        String ubicacion_dot = "C:\\Users\\denni\\Documents\\Varios_Progra\\EDD_PROYECTOS\\FASE_3\\Graphviz\\Archivos_TXT\\"+user+"ArbolABB.txt";
        String ubicacion_img = "C:\\Users\\denni\\Documents\\Varios_Progra\\EDD_PROYECTOS\\FASE_3\\Graphviz\\Imagenes\\Arboles\\ABB\\"+user+"ArbolABB.png";
    ...
    public void generar_graphviz_deImagen(String user, String num_img) {
        String ubicacion_dot = "C:\\Users\\denni\\Documents\\Varios_Progra\\EDD_PROYECTOS\\FASE_3\\Graphviz\\Archivos_TXT\\"+user+"ArbolABB.txt";
        String ubicacion_img = "C:\\Users\\denni\\Documents\\Varios_Progra\\EDD_PROYECTOS\\FASE_3\\Graphviz\\Imagenes\\Arboles\\ABB_Imagenes\\"+user+"ArbolABB"+num_img+".png";
        File dotFile = new File(ubicacion_dot);
        try {dotFile.createNewFile();} catch (Exception e) {}
        FileWriter writer;
        try {
